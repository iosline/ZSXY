...
import com.beijing.zzu.zsxy.widget.CircleTransform;
...
public class ImageLoader {
    ...
    public static void load(Context context, String url, ImageView iv) {
        Glide.with(context)
                .load(url)
                .diskCacheStrategy(DiskCacheStrategy.ALL)  //让Glide既缓存全尺寸图片，下次在任何ImageView加载图片的时候，
                // 全尺寸图片将从缓存中取出，重新调整大小，然后缓存
                .crossFade()
                .into(iv);
    }
